function sendMail() {
    ...
    var params = {
        ...
        member4GammerTag: document.getElementById("member_tag_4").value ? document.getElementById("member_tag_4").value : "Member tag 4",
    ...
    emailjs.send(serviceID, templateID, params)
        .then((res) => {
            ...
            document.getElementById("member_tag_4").value = "";
